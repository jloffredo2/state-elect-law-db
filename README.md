...
> National Conference of State Legislatures. 2023. *State Elections Legislation Database*. www.ncsl.org/research/elections-and-campaigns/elections-legislation-database.aspx (December 26, 2023).

> Voting Rights Lab. 2023. *Legislative Tracker*. https://tracker.votingrightslab.org/pending/search (December 26, 2023).
