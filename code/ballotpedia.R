...
ballotpedia_check_topics <- function(categories,topic){
...
build_ballotpedia_bill_database <- function(){
  ...
  ballotpedia_bill_database$AVAPPL = sapply(ballotpedia_bill_database$CATEGORIES, ballotpedia_check_topics, "Absentee/mail-in ballot request processes") 
