...
write.csv(db$vrl_bill_database, file = "output/vrl_bill_database.csv",row.names = FALSE)
save(db$vrl_bill_database, file = "output/vrl_bill_database.Rdata")

write.csv(db$vrl_provisions, file = "output/vrl_provisions.csv",row.names = FALSE)
save(db$vrl_provisions, file = "output/vrl_provisions.Rdata")
